...
/*======================*/
	...
	(function($){
		...
		// -------------------
			...
			$('.mob-int-true .mob-menu ul li a').on("click", function(){
				$(this).toggleClass('animate').next('ul').stop().slideToggle(300, "easeOutQuart");
			});
...
/*======================*/
	...
	(function($){
		...
		$('.widget_nav_menu ul li a').on('click',function(e){
